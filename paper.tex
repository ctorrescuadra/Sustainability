...
\Author{Emilio Font de Mora * and C\'esar Torres and Antonio Valero}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address[1]{%
 Centre of Research for Energy Resources and Consumption -- CIRCE, University of Zaragoza, Mariano Esquillor, \hl{15 50018,} Zaragoza, Spain; E-Mails: ctorrescuadra@gmail.com (C.T.);\\ valero@unizar.es (A.V.)
}

\corres{E-Mail: emilio.fontdemora@gmail.com; \linebreak \hl{Tel.: +1-111-111-111; Fax:+1-111-111-111.}\\
...
Being this the situation, some projects have estimated the potential biodiesel production in the EU. The IEE project \hl{RecOil} %please define
 states that biodiesel produced from UCO could replace 1.5\% of the EU-27 diesel consumption \cite{RecOil2013}. The final report of the IEE project \hl{BioDieNet} %please define
...
\item The glycerol does not follow an after-treatment process. The crude glycerol is either treated as a residue or sold as a low added-value co-product to soap \hl{unfolders} %please check the term; cannot verify
